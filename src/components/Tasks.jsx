...
const Tasks = () => {
  ...
  const getStatus = (completed) => {
    if (completed === true) {
      ...
      return (
        <p className=" text-[#F2C94C] bg-[#F2C94C]/10 rounded-full p-2">
          In-Progress
        </p>
      );
    }
                  ...
                  <TableCell sx={{ padding: "8px" }}>
                    <div className="flex items-center">
                      <img
                        ...
                        className="mr-2 "
                      />
                      <div className="flex-grow ">{task.todo}</div>
                      <div className="mr-2 ">{getStatus(task.completed)}</div>
                      <div className="mr-2 ">
